...
Invoke-RestMethod -Uri "$API_URL/gameobjects/CHASSIS_ID/interfaces" -Method Post -ContentType "application/json" `
  -Body '{"name": "VehicleControllerInterface", "properties": {"maxEngineForce": 1500}}'

# Drive the vehicle forward and steer left
Invoke-RestMethod -Uri "$API_URL/gameobjects/CHASSIS_ID/interfaces/VehicleControllerInterface/properties" -Method Patch -ContentType "application/json" `
  -Body '{"properties": {"engineForce": 1.0, "steering": -0.5}}'
```
